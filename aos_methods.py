...
# s = Service(executable_path='C:/Users/RAO/PycharmProjects/pythonProject/aos/chromedriver.exe')   #----RAO PATH FOR PYCHARM WORKING
# driver = webdriver.Chrome(service=s)    # -----RAO PATH FOR PYCHARM WORKING
